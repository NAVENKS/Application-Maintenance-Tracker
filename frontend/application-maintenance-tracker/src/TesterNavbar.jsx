...
export default function TesterNavbar({ children }) {
  ...
  const menuItems = [
    { text: 'Dashboard',  icon: <DashboardIcon />,  path: '/tester/dashboard' },
    { text: 'My Works',   icon: <InventoryIcon />,  path: '/tester/my-works' },
